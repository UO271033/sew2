...
<head>
    <meta charset="UTF-8"/>
    <title>Ejercicio 6 - Insertar Datos</title>
    <link rel="stylesheet" href="Ejercicio6.css">
	<meta name="viewport" content="width=device-width, initial-scale=1">
</head>
<body>
    <header>
        <h1>Ejercicio 6 - Insertar Datos</h1>
    </header>
    <nav>
    ...
    <main>
        ...
        <form action="#" method="post">
		    ...
		    <input id="valoracion" type="number" placeholder="10" name="valoracion" required>
		    <br>
            <input type="submit" class="button" name="insertaDatos" value="Insertar Datos" />
        </form>
    </main>
</body>
</html>
